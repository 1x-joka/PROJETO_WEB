...
create table continente (
    ...
    total_paises int default 0 -- Começando com 0, não um número negativo
);
...
create table pais (
    ...
    populacao_pais bigint not null, -- bignint = pode ultrapassar o limite de dados (além de 32bits)
...
create table governante (
    ...
    data_final_mandato date null, -- null para governantes em mandato atual
    id_pais int null,
    id_cidade int null,
    foreign key (id_pais) references pais(id_pais),
